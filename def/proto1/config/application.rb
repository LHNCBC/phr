...
module Proto1
  class Application < Rails::Application
    ...
    config.middleware.use Rack::Recaptcha,
      :public_key => '6LeJrsESAAAAAECrDjnD3t3UTS-d20bhSCK8fALq',
      :private_key => '6LeJrsESAAAAAJJOdVP2muLrGIaAaaRG68jURsfC',
      :proxy_host => host,
      :proxy_port => port, 
      :paths =>['/accounts/forgot_id','/accounts/add_user','/accounts/new',
          '/accounts/login','/accounts/forgot_password','/contact_us',
          '/contact_us/new','/contact_us/create']
    ...
    # form_js will be included in the generated_js files, we can omit them here
